...
;; annotations
(defmulti add-an-annotation
  "Add an annotation to the first parameter."
  (fn [named-entity _]
    (class named-entity)))
...
(defn add-annotation
  "Adds a number of annotations to the named entity."
